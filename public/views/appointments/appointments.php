...
<head>
    <meta charset="UTF-8">
    <title>Appointments - Patient DBMS</title>
            ...
            <div class="col-md-2 p-0">
                <div class="sidebar">
                    <nav class="nav flex-column">
                        ...
                        <a class="nav-link active" href="../appointments/appointments.php">
            ...
            <div class="col-md-10">
                <div class="container-fluid py-4">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <a href="appointment_create.php" class="btn btn-success">
                    ...
                    if($result->num_rows > 0){
                        ...
                        while($row = $result->fetch_array()){
                            ...
                            echo "<td><span class='badge status-badge " . $status_class . "'>" . $row['status'] . "</span></td>";
                            
                            echo "<td>" . date('M d, Y', strtotime($row['created_at'])) . "</td>";
                            echo "<td>";
                            echo '<a href="appointment_read.php?id='. $row['id'] .'" class="btn btn-info btn-action" title="View Record" data-toggle="tooltip"><span class="fa fa-eye"></span></a>';
                            echo '<a href="appointment_update.php?id='. $row['id'] .'" class="btn btn-warning btn-action" title="Update Record" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
                            if(in_array($user_role, [ROLE_DOCTOR, ROLE_SECRETARY, ROLE_DEVELOPER])){
                                echo '<a href="appointment_delete.php?id='. $row['id'] .'" class="btn btn-danger btn-action" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                            }
                            echo "</td>";
                            echo "</tr>";
                        }
                        ...
                        echo '<div class="alert alert-info"><em>No appointment records were found.</em></div>';
                    }
